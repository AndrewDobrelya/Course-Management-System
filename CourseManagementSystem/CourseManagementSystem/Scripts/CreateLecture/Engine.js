document.getElementById('cover').style.width = document.documentElement.clientWidth-10;
document.getElementById('cover').style.height = document.documentElement.clientHeight-10;
...
function frameFitting() {
    ...
    getCaretPosition();
    // window.scrollTo("#save", iWin.getSelection().focusNode.clientHeight);
}
function getCaretPosition() {
    var cursorPos;
    if (iDoc.selection) {
        var range = iDoc.selection.createRange().text;
        range.moveStart('textedit', -1);
        cursorPos = range.text.length;
    }
    else
    if (iDoc.getSelection) {
        cursorPos = iDoc.getSelection().focusOffset;
    }
    else
    if (iWin.getSelection) {
        cursorPos = iWin.getSelection().selectionStart;
    }
    return cursorPos;
}
    ...
    while (position.tagName != "HTML") {
        if (position.style.getPropertyValue("text-align") != null) {
            if (position.style.getPropertyValue("text-align") == "right") {
                document.getElementById("center").src = "res/Center.png";
                document.getElementById("left").src = "res/Left.png";
                document.getElementById("right").src = "res/RightB.png";
                document.getElementById("inwidth").src = "res/InWidth.png";
                break;
            }
            else
            if (position.style.getPropertyValue("text-align") == "center") {
                document.getElementById("center").src = "res/CenterB.png";
                document.getElementById("left").src = "res/Left.png";
                document.getElementById("right").src = "res/Right.png";
                document.getElementById("inwidth").src = "res/InWidth.png";
                break;
            }
            else
            if (position.style.getPropertyValue("text-align") == "justify") {
                ...
                document.getElementById("left").src = "res/Left.png";
                document.getElementById("right").src = "res/Right.png";
                document.getElementById("inwidth").src = "res/InWidthB.png";
                break;
            }
            else
            if (position.style.getPropertyValue("text-align") == "left") {
                document.getElementById("center").src = "res/Center.png";
                document.getElementById("left").src = "res/LeftB.png";
                document.getElementById("right").src = "res/Right.png";
                document.getElementById("inwidth").src = "res/InWidth.png";
                break;
            }
